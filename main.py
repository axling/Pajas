#!/usr/bin/env python
# The work in this file is licensed under 
# the the Creative Commons Attribution Non Commercial 3.0 license.
# Read more about the license here: http://creativecommons.org/licenses/by-n
# or see LICENSE for a the full license.
    ...
    def post(self, uid, page):
        ...
        if uid:
            if u'remove_point_tag' in self.request.POST:
                ...
                description = self.request.POST[u'description']
                try:
                    post_on_fb = self.request.POST[u'facebook_post']
                except KeyError:
                    post_on_fb = None
